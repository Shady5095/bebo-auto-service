...
class CarConditionExpandableWidget extends StatefulWidget {
  final int index;
  final CarSellModel carSellModel;

  const CarConditionExpandableWidget({
    Key? key,
    required this.index,
  ...
  @override
  State<CarConditionExpandableWidget> createState() =>
      _CarConditionExpandableWidgetState();
}

class _CarConditionExpandableWidgetState
    extends State<CarConditionExpandableWidget> {
  List<bool> isTapped = [
    true,
    true,
    true,
                          ...
                          ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return CircularPercentIndicatorWidget(
                                snapshot: snapshot,
                                conditionValue:
                                    (carConditionModel.condition)!.toDouble(),
