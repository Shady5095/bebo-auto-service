            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    '${dateTimeIntl.DateFormat.yMMMd('ar').format(
                        (widget.offersModel.addedTime
                            ?.toDate())!)}  :  ${dateTimeIntl.DateFormat
                        .jm('ar').format(
                        widget.offersModel.addedTime!.toDate())}',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Colors.white,
                ...
                children: [
                  ...
                  Text(
                    widget.offersModel.expireDate == null
                        ? 'غير محدد'
                        : '${dateTimeIntl.DateFormat.yMMMd('ar').format(
                        (widget.offersModel.expireDate
                            ?.toDate())!)}  :  ${dateTimeIntl.DateFormat
                        .jm('ar').format(
                        widget.offersModel.expireDate!.toDate())}',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: Colors.white,
                      fontStyle: FontStyle.italic,
